...
from axelrod.tests.property import (tournaments,
                                    ...
                                    spatial_tournaments,
                                    strategy_lists)
from axelrod.tournament import PROGRESS_BAR
import axelrod
...
#
    ...
    def test_no_progress_bar_play(self):
        ...
        call_progress_bar = lambda: PROGRESS_BAR.total
    ...
    def test_progress_bar_play(self):
        ...
        self.assertIsInstance(results, axelrod.ResultSet)
        self.assertEqual(PROGRESS_BAR.total, 15)
        self.assertEqual(PROGRESS_BAR.total,
                         PROGRESS_BAR.n)
    ...
    def test_my_player_things(self):
        expected_01 = [[(D, C), (D, C),(D, C),(C, C),(D, C),
                        (D, C),(D, C),(D, C),(C, C),(D, C)]]
        tourney = axelrod.Tournament(
            players=[axelrod.Cycler('DDDCD'), axelrod.Cooperator()],
            turns=10, repetitions=1)
        tourney.play()
        self.assertEqual(tourney.interactions_dict[(0, 1)], expected_01)
